...
$.fn.validatebox.defaults={required:false,validType:null,delay:200,missingMessage:"必填选项.",invalidMessage:null,tipPosition:"right",deltaX:0,novalidate:false,tipOptions:{showEvent:"none",hideEvent:"none",showDelay:0,hideDelay:0,zIndex:"",onShow:function(){
...
},message:"请输入正确的邮箱."},url:{validator:function(_29){
...
},message:"请输入正确的URL地址."},length:{validator:function(_2a,_2b){
var len=$.trim(_2a).length;
return len>=_2b[0]&&len<=_2b[1];
},message:"请输入在 {0} 和 {1}之间."},remote:{validator:function(_2c,_2d){
var _2e={};
_2e[_2d[1]]=_2c;
