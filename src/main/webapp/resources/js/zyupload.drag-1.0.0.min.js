        ...
        return this.each(function() {
            ...
            this.createHtml = function() {
                ...
                if (para.dragDrop ==true && para.isadd==false) {
                    ...
                    html += '						<input id="fileImage_2" type="file"  style="display:none"  size="100"  ' + multiple + ">";
                    html += '						<input id="fileImage_1" type="file"  style="display:none"  size="100"  ' + multiple + ">";
            ...
            this.addEvent = function() {
                if ($(".filePicker").length > 0) {
                    ...
                    function(e) {
                		...
                		var f=$("#fileImage_3").val();
                		
                		if(undefined==f){
                			$("#fileImage").hide();
                			$("#fileImage").attr("name","fileselect_3");
                    		$("#fileImage").attr("id","fileImage_3");
                    		
                    		$("#fileImage_1").show();
                    		$("#fileImage_1").attr("name","fileselect[]");
                    		$("#fileImage_1").attr("id","fileImage");
                    		
                		}else{
                			var file=$("#fileImage_2").val();
                			if(undefined !=file && ""==file){
                				$("#fileImage").hide();
                				$("#fileImage").attr("name","fileselect_4");
                        		$("#fileImage").attr("id","fileImage_4");
                        		
                        		$("#fileImage_2").show();
                        		$("#fileImage_2").attr("name","fileselect[]");
                        		$("#fileImage_2").attr("id","fileImage");
                			}
                		}
                   ...
                   // 	var file=$("#fileImage").val();
                     /*	if(""!=file && undefined !=file){
                         	...
                         	if(""==files && undefined !=files){
                         		...
                         		var f=$("#fileImage_2").val(file);
                         		if(""==f && undefined !=f){
                         			$("#fileImage_2").val(file);
                         		}
                         	}
                     		
                     		$("#fileImage").clone().appendTo("#copyImg").attr("name","fileselect_"+i);
                         }*/
                    })
                }
