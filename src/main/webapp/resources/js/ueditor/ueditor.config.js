...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        // 服务器统一请求接口路径
        , serverUrl:  "/EditorAndUploadDemo/ued/config"
        ...
        , toolbars: [[
            ...
            'simpleupload', 'insertimage', 'emotion', 'scrawl', 'insertvideo', 'music', 'attachment', 'map', 'webapp', 'pagebreak', 'template', 'background', '|',
        ...
        ,catchRemoteImageEnable : false//是否开启远程抓图
