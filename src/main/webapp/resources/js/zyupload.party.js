...
//        formdata.append("productTypeName", productTypeName);
        ...
        false);
        productTypeName=encodeURI(encodeURI(productTypeName));
        xhr.open("POST", self.url+"?productTypeName="+productTypeName, true);
        xhr.send(formdata)
    },
    ...
    $.fn.zyUpload = function(options, param) {
        ...
        return this.each(function() {
            ...
            this.createHtml = function() {
                ...
                if (para.dragDrop ==true && para.isadd==false) {
                    html += '<form id="uploadForm" action="' + para.url + '" method="post" enctype="multipart/form-data">';
                    
                    html+='		<table class="kv-table">';
                    html+='			<tbody>';
                   /* html+='				<tr>';
                    html+='                <td class="kv-label">类型名称</td>';
                    html+='                <td class="kv-content">  ';
                    html+='                     <input class="easyui-textbox" type="text" name="productTypeName" id="productTypeName" data-options="required:true" missingMessage="不能为空" style="height:35px;margin:0 0;width:80%;"/>';
                    html+='                </td>';
                    html+='             </tr>';
                    html+='             <tr>';
                    html+='					<td class="kv-label" colspan="2">';
                    html+='                      <div align="center">商品图片</div>';
                    html+='                 </td>';
                    html+='             </tr>';*/
                    ...
                    html += '					<div class="upload_btn">新增</div>';
                    html += "				</div>";
                    html += "			</div>";
                    ...
                    html += "		</div>";
                    html += '		<div id="uploadInf" class="upload_inf" align="center" style="color:red;font-size:18px;"></div>';
                    html += "	</div>";
                    ...
                    html += '					<div class="andArea">';
                    html += '						<div class="filePicker">点击选择文件</div>';
                    html += '						<input id="fileImage" type="file" size="100" name="fileselect[]" ' + multiple + ">";
                    
            /*        html += '						<div style="display:none">';
                    html += '							<input id="fileImage_1" type="file" size="100" name="fileselect_1"  ' + multiple + ">";
                    html += '							<input id="fileImage_2" type="file" size="100" name="fileselect_2" ' + multiple + ">";
                    html += "						</div>";*/
            ...
            this.addEvent = function() {
                if ($(".filePicker").length > 0) {
                    ...
                    function(e) {
/*                    	var f2=$("#fileImage_2").val();
                    	if(undefined !=f2 && ""!=f2 &&  null !=f2){
                    		alert("超过上传的最大上限!");
                    		return false;
                    	}*/
                    	...
                    	var file=$("#fileImage").val();
                     	if(""!=file && undefined !=file){
                         	var files=$("#fileImage_1").val();
                         	if(""==files && undefined !=files){
                         		$("#fileImage_1").val(file);
                         	}else{
                         		$("#fileImage_2").val(file);
                         	}
                         }
                    })
                }
